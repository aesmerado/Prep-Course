...
function mesesDelAño(array) {
  ...
  // Tu código:
  var j=0;
  var mesesEncontrados = [0, 0, 0];
    for (i=0;i<array.length;i++){
      if (array[i] === 'Enero' || array[i] === 'Marzo' || array[i] === 'Noviembre'){
      mesesEncontrados[j] = array[i]
      j++
      } 
      else {}
    }
  if (mesesEncontrados[0] === 0 || mesesEncontrados[1] === 0 || mesesEncontrados[2] === 0) {
...
function continueStatement(numero) {
  ...
  for (i=1;i<=10;i++){
    if (i === 5) continue;
    numero = numero + 2;
    if (i>=6) {array[i-2]= numero}
      else {array[i-1]= numero};
  }
 return array
}
